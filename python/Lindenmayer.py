...
lindenmayer.setAxiom("t=1 d=1 b")
...
lindenmayer.generateLocally()
print(lindenmayer.getScore().toString())
print('generated...')
...
model.cppsoundLoad('../csd/CsoundAC.csd')
model.cppsoundSetCommand("-m195 -odac")
model.cppsoundSetFilename(filename)
...
duration = score.getDuration()
print('Duration: %9.4f' % (duration))
print('Command:  ', model.cppsoundGetCommand())
print('Score:')
model.createCsoundScore()
scoreString =  score.getCsoundScore()
print(scoreString)
print('Performing...')
# model.performAll()
model.perform()
