<CsoundSynthesizer>
<CsOptions>
c:/mkg/Silence/consound -RWfo ./tobias.wav ./temp.orc ./temp.sco
</CsOptions>
<CsInstruments>
sr = 88200
kr = 88200
...
k1	oscili 	300, .2,1				
k2	oscili		200, .5,1
k3	oscili		400, .05,1				; res sweep

a1	oscili		p4*0.30, inote*0.998, 4
a2	oscili		p4*0.30, inote*1.002, 4
a3	oscili		p4*0.20, inote*1.000, 5
...
a1	oscili		p4*0.40, inote*0.998-.12, 06
a2	oscili		p4*0.40, inote*1.002-.12, 03
a3	oscili		p4*0.40, inote*1.002-.12, 06
a4	oscili		p4*0.70, inote-.24, 03
...
<CsScore>
f 1 0   16384 10  1					;fof
f 2 0   16384 19  .5  .5  270  .5			;fof
f 3 0   16384 10  1					;sine
f 4 0   16384 7  0 124 1 900 0			;saw
f 5 0   16384 7  0 124 1 900 1 1 1 1 1 1 1 1 	;Buzz
f06 0   16384 10 1 1 1 1 .7 .5 .3 .1 		;pulse
f10 0   16384 21  1					;noise
