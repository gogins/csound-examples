...
prints "instr %9.4f p2 %9.4f p3 %9.4f p4 %9.4f p5 %9.4f p6 %9.4f p7 %9.4f p8 %9.4f p9 %9.4f #%3d\n", p1, p2, p3, p4, p5, p6, p7, p8, p9, active(p1)
  afilt1    init      0
  afilt2    init      0
  afilt3    init      0
  afilt4    init      0
...
; frequency of the allpass filter.
  ilimit1   =  (1 - ipi * p8 / sr) / (1 + ipi * p8 / sr)
  ilimit2   =  (1 - ipi * p9 / sr) / (1 + ipi * p9 / sr)
