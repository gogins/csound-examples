...
kprate  oscili      1, iratrat, irattab            ; Pulse Rate
kamp    oscili      iamp, kprate, iplstab          ; Amplitude Pulse
kloop   linseg     0, .005, 1, iloop-.01, 1, .005,  0, p3-iloop-.01, 0 ; Gate in delay loop
kpan    oscili      1, 1/idur, ipantab             ; Panning
...
krate   oscili      1, iratrat, irattab            ; Pulse Rate
kloop   linseg     0, .005, 1, iloop-.01, 1, .005,  0, p3-iloop-.01, 0 ; Gate in delay loop
kpan    oscili      1, 1/idur, ipantab             ; Panning
kmix    oscili      1, 1/idur, imixtab             ; Fading

;                Amp   Fqc         Car   Mod    MAmp    Wave
abal    foscili   iamp, ifqc*krate, 1,    imodf, imodl,  1    ; FM Source
