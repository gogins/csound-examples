...
#define	FORMANT_DATA(N)	
	...
	invals	=	invals-1									;
	kfreq$N._U	tablei		1+(kx*(3/5)*invals),iBFA+(ivoice*15)+$N-1			;READ DATA FOR FREQUENCY (UPPER EDGE OF PANEL)
	kfreq$N._L	tablei		1+(((1-kx)*(1/5))+(4/5)*invals),iBFA+(ivoice*15)+$N-1		;READ DATA FOR FREQUENCY (LOWER EDGE OF PANEL)
	...
	kdbamp$N._U	tablei		1+(kx*(3/5)*invals),iBDbA+(ivoice*15)+$N-1			;READ DATA FOR INTENSITY (UPPER EDGE OF PANEL)                                      
	kdbamp$N._L	tablei		1+(((1-kx)*(1/5))+(4/5)*invals),iBDbA+(ivoice*15)+$N-1		;READ DATA FOR INTENSITY (LOWER EDGE OF PANEL)                                      
	...
	kbw$N._U	tablei		1+(kx*(3/5)*invals),iBBWA+(ivoice*15)+$N-1			;READ DATA FOR BANDWIDTH (UPPER EDGE OF PANEL)                                      
	kbw$N._L	tablei		1+(((1-kx)*(1/5))+(4/5)*invals),iBBWA+(ivoice*15)+$N-1		;READ DATA FOR BANDWIDTH (LOWER EDGE OF PANEL)                                      
