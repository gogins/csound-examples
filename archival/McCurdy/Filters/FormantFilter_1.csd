...
;BASS
giBF1	ftgen	0,  0, -5, -2,	600,	400,	250,	400,	350	;FREQ
giBF2	ftgen	0,  0, -5, -2,	1040,	1620,	1750,	750,	600	;FREQ
giBF3	ftgen	0,  0, -5, -2,	2250,	2400,	2600,	2400,	2400	;FREQ
giBF4	ftgen	0,  0, -5, -2,	2450,	2800,	3050,	2600,	2675	;FREQ
giBF5	ftgen	0,  0, -5, -2,	2750,	3100,	3340,	2900,	2950	;FREQ

giBDb1	ftgen	0, 0, -5, -2,	0,	0,	0,	0,	0	;dB
giBDb2	ftgen	0, 0, -5, -2,	-7,	-12,	-30,	-11,	-20	;dB
giBDb3	ftgen	0, 0, -5, -2,	-9,	-9,	-16,	-21,	-32	;dB
giBDb4	ftgen	0, 0, -5, -2,	-9,	-12,	-22,	-20,	-28	;dB
giBDb5	ftgen	0, 0, -5, -2,	-20,	-18,	-28,	-40,	-36	;dB

giBBW1	ftgen	0, 0, -5, -2,	60,	40,	60,	40,	40	;BAND WIDTH
giBBW2	ftgen	0, 0, -5, -2,	70,	80,	90,	80,	80	;BAND WIDTH
giBBW3	ftgen	0, 0, -5, -2,	110,	100,	100,	100,	100	;BAND WIDTH
giBBW4	ftgen	0, 0, -5, -2,	120,	120,	120,	120,	120	;BAND WIDTH
giBBW5	ftgen	0, 0, -5, -2,	130,	120,	120,	120,	120	;BAND WIDTH
;TENOR
giTF1	ftgen	0, 0, -5, -2,	650, 	400,	290,	400,	350	;FREQ
giTF2	ftgen	0, 0, -5, -2,	1080, 	1700,   1870,	800,	600	;FREQ
giTF3	ftgen	0, 0, -5, -2,	2650,	2600,   2800,	2600,	2700	;FREQ
giTF4	ftgen	0, 0, -5, -2,	2900,	3200,   3250,	2800,	2900	;FREQ
giTF5	ftgen	0, 0, -5, -2,	3250,	3580,   3540,	3000,	3300	;FREQ

giTDb1	ftgen	0, 0, -5, -2,	0,	0,	0,	0,	0	;dB
giTDb2	ftgen	0, 0, -5, -2,	-6,	-14,	-15,	-10,	-20	;dB
giTDb3	ftgen	0, 0, -5, -2,	-7,	-12,	-18,	-12,	-17	;dB
giTDb4	ftgen	0, 0, -5, -2,	-8,	-14,	-20,	-12,	-14	;dB
giTDb5	ftgen	0, 0, -5, -2,	-22,	-20,	-30,	-26,	-26	;dB

giTBW1	ftgen	0, 0, -5, -2,	80,	70,	40,	40,	40	;BAND WIDTH
giTBW2	ftgen	0, 0, -5, -2,	90,	80,	90,	80,	60	;BAND WIDTH
giTBW3	ftgen	0, 0, -5, -2,	120,	100,	100,	100,	100	;BAND WIDTH
giTBW4	ftgen	0, 0, -5, -2,	130,	120,	120,	120,	120	;BAND WIDTH                                         
giTBW5	ftgen	0, 0, -5, -2,	140,	120,	120,	120,	120	;BAND WIDTH
;COUNTER TENOR
giCTF1	ftgen	0, 0, -5, -2,	660,	440,	270,	430,	370	;FREQ
giCTF2	ftgen	0, 0, -5, -2,	1120,	1800,	1850,	820,	630	;FREQ
giCTF3	ftgen	0, 0, -5, -2,	2750,	2700,	2900,	2700,	2750	;FREQ
giCTF4	ftgen	0, 0, -5, -2,	3000,	3000,	3350,	3000,	3000	;FREQ
giCTF5	ftgen	0, 0, -5, -2,	3350,	3300,	3590,	3300,	3400	;FREQ

giTBDb1	ftgen	0, 0, -5, -2,	0,	0,	0,	0,	0	;dB
giTBDb2	ftgen	0, 0, -5, -2,	-6,	-14,	-24,	-10,	-20	;dB
giTBDb3	ftgen	0, 0, -5, -2,	-23,	-18,	-24,	-26,	-23	;dB
giTBDb4	ftgen	0, 0, -5, -2,	-24,	-20,	-36,	-22,	-30	;dB
giTBDb5	ftgen	0, 0, -5, -2,	-38,	-20,	-36,	-34,	-30	;dB
...
giTBW5	ftgen	0, 0, -5, -2,	140,	120,	120,	120,	120	;BAND WIDTH
;ALTO
giAF1	ftgen	0, 0, -5, -2,	800,	400,	350,	450,	325	;FREQ
giAF2	ftgen	0, 0, -5, -2,	1150,	1600,	1700,	800,	700	;FREQ
giAF3	ftgen	0, 0, -5, -2,	2800,	2700,	2700,	2830,	2530	;FREQ
giAF4	ftgen	0, 0, -5, -2,	3500,	3300,	3700,	3500,	2500	;FREQ
giAF5	ftgen	0, 0, -5, -2,	4950,	4950,	4950,	4950,	4950	;FREQ

giADb1	ftgen	0, 0, -5, -2,	0,	0,	0,	0,	0	;dB
giADb2	ftgen	0, 0, -5, -2,	-4,	-24,	-20,	-9,	-12	;dB
giADb3	ftgen	0, 0, -5, -2,	-20,	-30,	-30,	-16,	-30	;dB
giADb4	ftgen	0, 0, -5, -2,	-36,	-35,	-36,	-28,	-40	;dB
giADb5	ftgen	0, 0, -5, -2,	-60,	-60,	-60,	-55,	-64	;dB

giABW1	ftgen	0, 0, -5, -2,	50,	60,	50,	70,	50	;BAND WIDTH
giABW2	ftgen	0, 0, -5, -2,	60,	80,	100,	80,	60	;BAND WIDTH
giABW3	ftgen	0, 0, -5, -2,	170,	120,	120,	100,	170	;BAND WIDTH
giABW4	ftgen	0, 0, -5, -2,	180,	150,	150,	130,	180	;BAND WIDTH
giABW5	ftgen	0, 0, -5, -2,	200,	200,	200,	135,	200	;BAND WIDTH
;SOPRANO
giSF1	ftgen	0, 0, -5, -2,	800,	350,	270,	450,	325	;FREQ
giSF2	ftgen	0, 0, -5, -2,	1150,	2000,	2140,	800,	700	;FREQ
giSF3	ftgen	0, 0, -5, -2,	2900,	2800,	2950,	2830,	2700	;FREQ
giSF4	ftgen	0, 0, -5, -2,	3900,	3600,	3900,	3800,	3800	;FREQ
giSF5	ftgen	0, 0, -5, -2,	4950,	4950,	4950,	4950,	4950	;FREQ

giSDb1	ftgen	0, 0, -5, -2,	0,	0,	0,	0,	0	;dB
giSDb2	ftgen	0, 0, -5, -2,	-6,	-20,	-12,	-11,	-16	;dB
giSDb3	ftgen	0, 0, -5, -2,	-32,	-15,	-26,	-22,	-35	;dB
giSDb4	ftgen	0, 0, -5, -2,	-20,	-40,	-26,	-22,	-40	;dB
giSDb5	ftgen	0, 0, -5, -2,	-50,	-56,	-44,	-50,	-60	;dB

giSBW1	ftgen	0, 0, -5, -2,	80,	60,	60,	70,	50	;BAND WIDTH
giSBW2	ftgen	0, 0, -5, -2,	90,	90,	90,	80,	60	;BAND WIDTH
giSBW3	ftgen	0, 0, -5, -2,	120,	100,	100,	100,	170	;BAND WIDTH
giSBW4	ftgen	0, 0, -5, -2,	130,	150,	120,	130,	180	;BAND WIDTH
giSBW5	ftgen	0, 0, -5, -2,	140,	200,	120,	135,	200	;BAND WIDTH
...
instr	2
	...
	elseif	gkinput=1	then				;IF 'Buzz' IS SELECTED FOR INPUT
		asigL		buzz	1,kBuzFrq,(sr/2)/kBuzFrq,gicos	;CREATE BUZZ TONE
...
#define	FORMANT_DATA(N)	
	#
	kfreq$N._U	tablei		kx*(2/5)*5,giBF1+(i(gkvoice)*15)+$N-1			;READ DATA FOR FREQUENCY (UPPER EDGE OF PANEL)
	kfreq$N._L	tablei		((3/5)+((1-kx)*(1/5)))*5,giBF1+(i(gkvoice)*15)+$N-1		;READ DATA FOR FREQUENCY (LOWER EDGE OF PANEL)
	kdbamp$N._U	tablei		kx*(2/5)*5,giBDb1+(i(gkvoice)*15)+$N-1			;READ DATA FOR INTENSITY (UPPER EDGE OF PANEL)                                      
	kdbamp$N._L	tablei		((4/5)+((1-kx)*(1/5)))*5,giBDb1+(i(gkvoice)*15)+$N-1	;READ DATA FOR INTENSITY (LOWER EDGE OF PANEL)                                      
	kbw$N._U	tablei		kx*(2/5)*5,giBBW1+(i(gkvoice)*15)+$N-1			;READ DATA FOR BANDWIDTH (UPPER EDGE OF PANEL)                                      
	kbw$N._L	tablei		((3/5)+((1-kx)*(1/5)))*5,giBBW1+(i(gkvoice)*15)+$N-1	;READ DATA FOR BANDWIDTH (LOWER EDGE OF PANEL)                                      
