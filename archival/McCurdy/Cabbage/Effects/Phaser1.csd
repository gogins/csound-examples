...
rslider bounds(10, 11, 70, 70), text("Frequency"), channel("freq"), range(20.0, 5000, 160, 0.25),colour(255,100,100),fontcolour("white")
rslider bounds(75, 11, 70, 70), text("Feedback"), channel("feedback"), range(-0.99, 0.99, 0.9),colour(255,100,100),fontcolour("white")
rslider bounds(140, 11, 70, 70), text("N.Ords."), channel("ord"), range(1, 256, 32, 0.5,1),colour(255,100,100),fontcolour("white")
rslider bounds(205, 11, 70, 70), text("Mix"), channel("mix"), range(0, 1.00, 1),colour(255,100,100),fontcolour("white")
rslider bounds(270, 11, 70, 70), text("Level"), channel("level"), range(0, 1.00, 0.7),colour(255,100,100),fontcolour("white")
}
</Cabbage>
