...
xypad bounds(5, 5, 350, 350), channel("cf", "bw"), rangex(0, 1, 0.5), rangey(0, 1, 0.3), text("x:cutoff | y:bandwidth")
...
rslider bounds(368, 93, 90, 90), text("Mix"),		fontcolour("white"), 		channel("mix"), 	range(0, 1.00, 1)
rslider bounds(368,190, 90, 90), text("Level"),		fontcolour("white"), 		channel("level"), 	range(0, 1.00, 1)
