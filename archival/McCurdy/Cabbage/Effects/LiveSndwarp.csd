...
rslider  bounds(465, 30,  60, 60), text("LPF"), channel("Cutoff"), range(20, 20000,  4000, 0.5), tracker("red")
}

groupbox bounds(  0,100, 530,100), text("Grains"), colour(35, 35, 45), fontcolour(255,130,130){
rslider  bounds(  5,130,  60, 60), text("Size"), channel("wsize"), range(1, 88200, 7000, 0.25), tracker("red")
rslider  bounds( 65,130,  60, 60), text("Size Rnd."), channel("rnd"), range(0, 30000, 1000, 0.375), tracker("red")
rslider  bounds(125,130,  60, 60), text("Pitch"), channel("pch"), range(0.01, 8, 1, 0.5), tracker("red")
rslider  bounds(185,130,  60, 60), text("Semis"), channel("semis"), range(-48, 48, 0,1,1), tracker("red")
rslider  bounds(245,130,  60, 60), text("Density"), channel("olaps"), range(1, 100, 10, 1, 1), tracker("red")
...
rslider  bounds( 10,365, 60, 60), text("Uni.Note"), channel("UniNote"), range(0, 127, 72,1,1), tracker("red")
