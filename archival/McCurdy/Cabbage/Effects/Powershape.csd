...
hslider bounds(  5, 20,290, 35),          colour("white"), tracker("white"), channel("amount"), range(1, 500, 1, 0.5,0.001)
label   bounds(130, 47, 60, 11), text("Amount"), fontcolour("white")
hslider bounds(  5, 60,290, 35),          colour("white"), tracker("white"),  channel("level"),  range(0, 50, 0.5, 0.25,0.000001)    
