<Cabbage>
form caption("HRTF 3D") size(365, 260)
...
hslider bounds(265,  40, 90,55), channel("L_R_In"), range(0, 1.00, 0), caption("L/R In")
...
image bounds(5,235, 205, 20), colour(100,100,100,80), plant("credit"), line(0){
