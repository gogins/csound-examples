...
#define	LOOP(COUNT)	
	...
	kphs$COUNTold	init	0				;initialise phase value from previous k-rate interation (needed for first comparison in the next line)
	if kphs$COUNT<kphs$COUNTold then			;if phase has just reset to the beginning...
	...
	kphs$COUNTold	=	kphs$COUNT			;create phase value from previous k-rate iteration which will be used in the next iteration
	...
	;	schedkwhen ktrigger, kmintim, kmaxnum, kinsnum,    kwhen,       kdur
		schedkwhen ktrig,       0,        0,   p1+$COUNT,  gk$COUNTDly, kp3	;generate a note (if a trigger / '1' value) is met
	#
...
instr	$I
	...
	ibcL	=	i(gkbcL)+1
	ibcR	=	i(gkbcR)+1	
	asig 	barmodel	ibcL, ibcR, i(gk$COUNTPch)*i(gkMasterPch), ib, 0, p3, 0.5, 1000*ivel, 0.07	;KALIMBA SOUND CREATED USING barmodel OPCODE (SEE CSOUND MANUAL FOR MORE INFO.)
...
#define	ResetRow(COUNT)
	#
	FLsetVal_i	0,gih$COUNT_1	
	FLsetVal_i	0,gih$COUNT_2	
	FLsetVal_i	0,gih$COUNT_3	
	FLsetVal_i	0,gih$COUNT_4	
	FLsetVal_i	0,gih$COUNT_5	
	FLsetVal_i	0,gih$COUNT_6	
	FLsetVal_i	0,gih$COUNT_7	
	FLsetVal_i	0,gih$COUNT_8	
	FLsetVal_i	0,gih$COUNT_9	
	FLsetVal_i	0,gih$COUNT_10      
	FLsetVal_i	0,gih$COUNT_11      
	FLsetVal_i	0,gih$COUNT_12      
	FLsetVal_i	0,gih$COUNT_13      
	FLsetVal_i	0,gih$COUNT_14      
	FLsetVal_i	0,gih$COUNT_15      
	FLsetVal_i	0,gih$COUNT_16      
	FLsetVal_i	0,gih$COUNT_17      
	FLsetVal_i	0,gih$COUNT_18      
	FLsetVal_i	0,gih$COUNT_19      
	FLsetVal_i	0,gih$COUNT_20      
	FLsetVal_i	0,gih$COUNT_21      
	FLsetVal_i	0,gih$COUNT_22      
	FLsetVal_i	0,gih$COUNT_23      
	FLsetVal_i	0,gih$COUNT_24      
	FLsetVal_i	0,gih$COUNT_25      
	FLsetVal_i	0,gih$COUNT_26      
	FLsetVal_i	0,gih$COUNT_27      
	FLsetVal_i	0,gih$COUNT_28      
	FLsetVal_i	0,gih$COUNT_29      
	FLsetVal_i	0,gih$COUNT_30      
	FLsetVal_i	0,gih$COUNT_31      
	FLsetVal_i	0,gih$COUNT_32     
