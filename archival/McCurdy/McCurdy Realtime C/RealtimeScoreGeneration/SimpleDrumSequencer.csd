...
gkval,gih$COUNT_01	FLbutton	"",	1,    0,    4,     20,     20,    100, iy,   0,       10,        0,        0,       $COUNT,         1 
gkval,gih$COUNT_02	FLbutton	"",	1,    0,    4,     20,     20,    120, iy,   0,       10,        0,        0,       $COUNT,         2  
gkval,gih$COUNT_03	FLbutton	"",	1,    0,    4,     20,     20,    140, iy,   0,       10,        0,        0,       $COUNT,         3  
gkval,gih$COUNT_04	FLbutton	"",	1,    0,    4,     20,     20,    160, iy,   0,       10,        0,        0,       $COUNT,         4  
gkval,gih$COUNT_05	FLbutton	"",	1,    0,    4,     20,     20,    180, iy,   0,       10,        0,        0,       $COUNT,         5  
gkval,gih$COUNT_06	FLbutton	"",	1,    0,    4,     20,     20,    200, iy,   0,       10,        0,        0,       $COUNT,         6  
gkval,gih$COUNT_07	FLbutton	"",	1,    0,    4,     20,     20,    220, iy,   0,       10,        0,        0,       $COUNT,         7  
gkval,gih$COUNT_08	FLbutton	"",	1,    0,    4,     20,     20,    240, iy,   0,       10,        0,        0,       $COUNT,         8  
gkval,gih$COUNT_09	FLbutton	"",	1,    0,    4,     20,     20,    260, iy,   0,       10,        0,        0,       $COUNT,         9  
gkval,gih$COUNT_10	FLbutton	"",	1,    0,    4,     20,     20,    280, iy,   0,       10,        0,        0,       $COUNT,        10 
gkval,gih$COUNT_11	FLbutton	"",	1,    0,    4,     20,     20,    300, iy,   0,       10,        0,        0,       $COUNT,        11 
gkval,gih$COUNT_12	FLbutton	"",	1,    0,    4,     20,     20,    320, iy,   0,       10,        0,        0,       $COUNT,        12 
gkval,gih$COUNT_13	FLbutton	"",	1,    0,    4,     20,     20,    340, iy,   0,       10,        0,        0,       $COUNT,        13 
gkval,gih$COUNT_14	FLbutton	"",	1,    0,    4,     20,     20,    360, iy,   0,       10,        0,        0,       $COUNT,        14 
gkval,gih$COUNT_15	FLbutton	"",	1,    0,    4,     20,     20,    380, iy,   0,       10,        0,        0,       $COUNT,        15 
gkval,gih$COUNT_16	FLbutton	"",	1,    0,    4,     20,     20,    400, iy,   0,       10,        0,        0,       $COUNT,        16
gk$COUNTGain, ih$COUNTGain		FLslider 	"",		0,      1,    0,    3,     -1,   100,      15,  420, iy+2
FLsetVal_i	0.7, 	ih$COUNTGain
FLsetColor	255, 255, 255, ih$COUNTGain		;SET PRIMARY COLOUR TO WHITE
#
$ROW(1)
$ROW(2)
$ROW(3)
...
#define	ROW(N)
	#
	FLsetVal_i	0, gih$N_01
	FLsetVal_i	0, gih$N_02
	FLsetVal_i	0, gih$N_03
	FLsetVal_i	0, gih$N_04
	FLsetVal_i	0, gih$N_05
	FLsetVal_i	0, gih$N_06
	FLsetVal_i	0, gih$N_07
	FLsetVal_i	0, gih$N_08
	FLsetVal_i	0, gih$N_09
	FLsetVal_i	0, gih$N_10
	FLsetVal_i	0, gih$N_11
	FLsetVal_i	0, gih$N_12
	FLsetVal_i	0, gih$N_13
	FLsetVal_i	0, gih$N_14
	FLsetVal_i	0, gih$N_15
	FLsetVal_i	0, gih$N_16
	#
	$ROW(1)
	$ROW(2)
	$ROW(3)
