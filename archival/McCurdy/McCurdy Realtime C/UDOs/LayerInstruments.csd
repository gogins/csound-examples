...
instr	1	; instrument that calls UDO
	LayerInstruments	gklayers,2,3600,1
endin

instr	2	; instrument to be called
	asig	vco2	1,cpsmidinn(60+((p4-1)*2)),4,0.5	;layers create a whole tone scale rising above middle C
	aenv 	linenr	0.1, 0.5, 3, 0.01	
