...
#define	FORMANT(N)
	...
	invals		=		invals-1								;
	k$Nform 	tablei		1+(kvowel*invals), iBF1+(ivoice*15)+$N-1	;READ FORMANT FREQUENCY FROM TABLE
	k$Ndb 		tablei		1+(kvowel*invals), iBDb1+(ivoice*15)+$N-1	;READ DECIBEL VALUE FROM TABLE
	k$Namp		=		ampdb(k$Ndb)					;CONVERT TO AN AMPLITUDE VALUE                                                
	k$Nband 	tablei		1+(kvowel*invals), iBBW1+(ivoice*15)+$N-1	;READ BANDWIDTH FROM TABLE
	#
