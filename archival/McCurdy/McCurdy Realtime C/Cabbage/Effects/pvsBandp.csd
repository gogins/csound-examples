...
vslider bounds( 10,  0,  60,200), text("Low Cut"), channel("lowcut"), range(20, 20000, 500,0.5), colour("black"), FontColour("black"), tracker("yellow")
vslider bounds( 70,  0,  60,200), text("Low Full"), channel("lowfull"), range(20, 20000, 550,0.5), colour("black"), tracker("yellow")
vslider bounds(130,  0,  60,200), text("High Full"), channel("highfull"), range(20, 20000,1900,0.5), colour("black"), tracker("yellow")
vslider bounds(190,  0,  60,200), text("High Cut"), channel("highcut"), range(20, 20000, 2000,0.5), colour("black"), tracker("yellow")
