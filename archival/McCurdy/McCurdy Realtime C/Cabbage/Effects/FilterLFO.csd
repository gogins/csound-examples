...
rslider bounds( 10, 11, 70, 70), text("Freq."), colour( 30, 30, 30),	tracker("black"),	fontcolour("white"), 		channel("cf"), 		range(20, 20000, 300, 0.333)
...
rslider  bounds(515, 11, 70, 70), text("Amp"), colour( 30, 30 ,30),	tracker("black"), fontcolour("white"), channel("LFOamp"), range(0, 4.00, 0.67)
...
rslider  bounds(515, 91, 70, 70), text("Amp"), colour( 30, 30 ,30),	tracker("black"), fontcolour("white"), channel("LFOamp2"), range(0, 4.00, 2.5)
