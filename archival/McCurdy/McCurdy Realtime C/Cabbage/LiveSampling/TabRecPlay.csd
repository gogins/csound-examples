...
label    bounds( 22, 75, 60, 14), text("Record") 
label    bounds( 95, 75, 60, 14), text("Pause") 
label    bounds(153, 75, 70, 14), text("Play Loop") 
label    bounds(222, 75, 70, 14), text("Play Once") 
...
hslider bounds(  5, 145, 280,50), channel("LoopBeg"), range(0, 1, 0)	;, text("Loop Begin")
label   bounds(113, 185,  70,13), text("Loop Begin") 
hslider bounds(  5, 195, 280,50), channel("LoopEnd"), range(0, 1, 1)	;, text("Loop End")
label   bounds(117, 235,  70,13), text("Loop End") 
hslider bounds(  5, 245, 280,50), channel("InGain"), range(0, 1, 1)	;, text("Input Gain")
label   bounds(114, 285,  70,13), text("Input Gain") 
hslider bounds(  5, 295, 280,50), channel("OutGain"), range(0, 1, 1)	;, text("Output Gain")
label   bounds(110, 335,  80,13), text("Output Gain") 
