...
hslider bounds(  5, 245, 280,50), channel("LoopEnd"), range(0, 1, 1)	;, text("Loop End")
label   bounds(117, 285,  70,13), text("Loop End") 
hslider bounds(  5, 295, 280,50), channel("InGain"), range(0, 1, 1)	;, text("Input Gain")
label   bounds(114, 335,  70,13), text("Input Gain") 
hslider bounds(  5, 345, 280,50), channel("OutGain"), range(0, 1, 1)	;, text("Output Gain")
label   bounds(110, 385,  80,13), text("Output Gain") 
