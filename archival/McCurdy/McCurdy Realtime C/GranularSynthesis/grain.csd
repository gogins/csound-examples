...
instr	1
	...
	aSigL	grain 	gkamp, kpitch, kdens, -(gkampoff*gkamp), kfmd, gkdur, isfnL, iwfn, imgdur , i(gkgrnd)
	aSigR	grain 	gkamp, kpitch, kdens, -(gkampoff*gkamp), kfmd, gkdur, isfnR, iwfn, imgdur , i(gkgrnd)
