...
instr	1	; WAVELET GENERATING INSTRUMENT
	...
	kupdate	changed	gkamp1, gkamp2, gkamp3, gkamp4, gkamp5, gkamp6, gkamp7, gkamp8, gkamp9, gkamp10, gkamp11, gkamp12, gkamp13, gkamp14, gkamp15, gkamp16, gkamp17, gkamp18, gkamp19, gkamp20 
	if kupdate=1 then		;IF A TRIGGER IMPULSE HAS BEEN GENERATED...
		...
		giwave	ftgen	1,0,4096,10,1-i(gkamp1), 1-i(gkamp2), 1-i(gkamp3), 1-i(gkamp4), 1-i(gkamp5), 1-i(gkamp6), 1-i(gkamp7), 1-i(gkamp8), 1-i(gkamp9), 1-i(gkamp10), 1-i(gkamp11), 1-i(gkamp12), 1-i(gkamp13), 1-i(gkamp14), 1-i(gkamp15), 1-i(gkamp16), 1-i(gkamp17), 1-i(gkamp18), 1-i(gkamp19), 1-i(gkamp20)
