...
#define	MORPH(VAR'NDX)	#
	...
	k$VARXTop	ntrpol	k$VAR1,k$VAR2,gkx	;CREATE AN INTERIM VARIABLE INTERPOLATED BETWEEN PRESET 1 AND PRESET 2 (UPPER EDGE OF FLpanel)
	k$VARXBot	ntrpol	k$VAR3,k$VAR4,gkx	;CREATE AN INTERIM VARIABLE INTERPOLATED BETWEEN PRESET 3 AND PRESET 4 (BOTTOM EDGE OF FLpanel)
	k$VAR		ntrpol	k$VARXBot,k$VARXTop,gky	;DERIVE THE FINAL VALUE FOR THE REQUIRED PARAMETER BY INTERPOLATING BETWEEN UPPER EDGE VARIABLE AND BOTTOM EDGE VARIABLE
