...
gkfreq1,ihfreq1			FLslider 	"Frequency 1",			20,  10000, -1,    23,   idfreq1,     490,      25,   5,    50+15
gkfreq2,ihfreq2			FLslider 	"Frequency 2",			20,  10000, -1,    23,   idfreq2,     490,      25,   5,   100+15  
...
gkfeedback1,ihfeedback1		FLslider 	"Feedback 1",			0,    .999,  0,    23,   idfeedback1, 490,      25,   5,   300+15
gkfeedback2,ihfeedback2		FLslider 	"Feedback 2",			0,    .999,  0,    23,   idfeedback2, 490,      25,   5,   350+15
...
ih		 	FLbox  	"Wguide2 can imbue the resosnant characteristics of a metal   ", 	1,      5,     14,    490,    15,     5, 360
ih		 	FLbox  	"plate to an impulse signal.                                  ", 	1,      5,     14,    490,    15,     5, 380
ih		 	FLbox  	"In this implementation three options for the impulse (input) ", 	1,      5,     14,    490,    15,     5, 400
ih		 	FLbox  	"signal are provided: (1) Sound file (2) Live input and (3)   ", 	1,      5,     14,    490,    15,     5, 420
ih		 	FLbox  	"a stream of click impulses.                                  ", 	1,      5,     14,    490,    15,     5, 440
...
ih		 	FLbox  	"should not exceed 0.5.                                       ", 	1,      5,     14,    490,    15,     5, 520
ih		 	FLbox  	"The frequencies of the two waveguides (1/delay_time) can be  ", 	1,      5,     14,    490,    15,     5, 540
ih		 	FLbox  	"controlled independently. 'Freq. 1&2 Scaling' multiplies both", 	1,      5,     14,    490,    15,     5, 560
ih		 	FLbox  	"waveguide frequencies by its value to demonstrate how the    ", 	1,      5,     14,    490,    15,     5, 580
ih		 	FLbox  	"whole timbre can be transposed up or down.                   ", 	1,      5,     14,    490,    15,     5, 600
ih		 	FLbox  	"This instrument can also be played from a MIDI keyboard in   ", 	1,      5,     14,    490,    15,     5, 620
ih		 	FLbox  	"which case 'Frequency 1' is determined by the note played and", 	1,      5,     14,    490,    15,     5, 640
ih		 	FLbox  	"'Frequency 2' by the position of controller 1/mod. wheel.    ", 	1,      5,     14,    490,    15,     5, 660
ih		 	FLbox  	"MIDI note velocity determines the amplitude and tone of the  ", 	1,      5,     14,    490,    15,     5, 680
ih		 	FLbox  	"impulse sound.                                               ", 	1,      5,     14,    490,    15,     5, 700
...
instr	1	;MIDI INSTRUMENT
	...
	aresL	wguide2 aImpulseL,   afreq1, afreq2, gkcutoff1, gkcutoff2, gkfeedback1, gkfeedback2	;APPLY WGUIDE 2 FILTERING
	aresR	wguide2 aImpulseR,   afreq1, afreq2, gkcutoff1, gkcutoff2, gkfeedback1, gkfeedback2	;APPLY WGUIDE 2 FILTERING
