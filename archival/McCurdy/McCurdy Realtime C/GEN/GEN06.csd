...
ih		 	FLbox  	"and durations (in table points) alternate. Every other value,", 	1,      5,     14,    490,    15,     5,  80
ih		 	FLbox  	"however, defines a 'point of inflexion' where the curve      ", 	1,      5,     14,    490,    15,     5, 100
ih		 	FLbox  	"changes from convex to concave or vice versa.                ", 	1,      5,     14,    490,    15,     5, 120
ih		 	FLbox  	"The number of curve segments is arbitrary and can be defined ", 	1,      5,     14,    490,    15,     5, 140
ih		 	FLbox  	"by the user in the function table provided the table ends on ", 	1,      5,     14,    490,    15,     5, 160
ih		 	FLbox  	"a value or point of inflexion.                               ", 	1,      5,     14,    490,    15,     5, 180
ih		 	FLbox  	"In this example the function table created is used by an     ", 	1,      5,     14,    490,    15,     5, 200
ih		 	FLbox  	"audio oscillator ('poscil'). Function table size is modified ", 	1,      5,     14,    490,    15,     5, 220
ih		 	FLbox  	"dynamically to always equal the sum of all durations defined.", 	1,      5,     14,    490,    15,     5, 240
ih		 	FLbox  	"Post normalisation of the table is on, i.e. GEN routine (p4) ", 	1,      5,     14,    490,    15,     5, 260
ih		 	FLbox  	"is given as a positive number. This means that the table will", 	1,      5,     14,    490,    15,     5, 280
ih		 	FLbox  	"be rescaled so that a maxmima or minima hit 1 or -1.         ", 	1,      5,     14,    490,    15,     5, 300
ih		 	FLbox  	"Other uses of this GEN routine might be to design envelope   ", 	1,      5,     14,    490,    15,     5, 320
ih		 	FLbox  	"shapes for amplitude control, panning trajectory, window     ", 	1,      5,     14,    490,    15,     5, 340
ih		 	FLbox  	"functions etc.                                               ", 	1,      5,     14,    490,    15,     5, 360
ih		 	FLbox  	"If you enable Csound displays (i.e. if you don't use the -d  ", 	1,      5,     14,    490,    15,     5, 380
ih		 	FLbox  	"flag) you can observe changes visually as well as aurally.   ", 	1,      5,     14,    490,    15,     5, 400
