...
ih		 	FLbox  	"GEN08 creates attempts to create the smoothest possible      ", 	1,      5,     14,    490,    15,     5,  40
ih		 	FLbox  	"piecewise cubic spline curve through the sequence of ordinate", 	1,      5,     14,    490,    15,     5,  60
ih		 	FLbox  	"values and segment durations provided in the function table. ", 	1,      5,     14,    490,    15,     5,  80
ih		 	FLbox  	"The number of segments can be defined by the user provided   ", 	1,      5,     14,    490,    15,     5,  80
ih		 	FLbox  	"the table ends with an ordinate value and not a duration.    ", 	1,      5,     14,    490,    15,     5, 100
ih		 	FLbox  	"Beyond p4 in the function table definition ordinate values   ", 	1,      5,     14,    490,    15,     5, 120
ih		 	FLbox  	"and segment durations (in table points) alternate.           ", 	1,      5,     14,    490,    15,     5, 140
ih		 	FLbox  	"In this example the function table is used by an audio       ", 	1,      5,     14,    490,    15,     5, 160
ih		 	FLbox  	"oscillator (poscil) to create an audio signal.               ", 	1,      5,     14,    490,    15,     5, 180
ih		 	FLbox  	"Other uses for GEN08 might include the creation of envelopes ", 	1,      5,     14,    490,    15,     5, 200
ih		 	FLbox  	"for amplitude control or trajectories in spatialisation.     ", 	1,      5,     14,    490,    15,     5, 220
ih		 	FLbox  	"If you enable Csound displays (i.e. if you don't use the -d  ", 	1,      5,     14,    490,    15,     5, 240
ih		 	FLbox  	"flag) you can observe changes visually as well as aurally.   ", 	1,      5,     14,    490,    15,     5, 260
