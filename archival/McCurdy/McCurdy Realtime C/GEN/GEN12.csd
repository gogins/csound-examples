...
ih		 	FLbox  	"'xint' specifies the x interval [0 to +xint] over which the  ", 	1,      5,     14,    490,    15,     5,  80
ih		 	FLbox  	"function is defined.                                         ", 	1,      5,     14,    490,    15,     5, 100
ih		 	FLbox  	"This subroutine draws the natural log of a modified Bessel   ", 	1,      5,     14,    490,    15,     5, 120
ih		 	FLbox  	"function of the second kind, order 0 (commonly written as I  ", 	1,      5,     14,    490,    15,     5, 140
ih		 	FLbox  	"subscript 0), over the x-interval requested. The call should ", 	1,      5,     14,    490,    15,     5, 160
ih		 	FLbox  	"have rescaling inhibited.                                    ", 	1,      5,     14,    490,    15,     5, 180
ih		 	FLbox  	"The function is useful as an amplitude scaling factor in     ", 	1,      5,     14,    490,    15,     5, 200
ih		 	FLbox  	"cycle-synchronous amplitude-modulated FM. (See Palamin &     ", 	1,      5,     14,    490,    15,     5, 220
ih		 	FLbox  	"Palamin, J. Audio Eng. Soc., 36/9, Sept. 1988, pp.671-684.)  ", 	1,      5,     14,    490,    15,     5, 240
ih		 	FLbox  	"The algorithm is interesting because it permits the normally ", 	1,      5,     14,    490,    15,     5, 260
ih		 	FLbox  	"symmetric FM spectrum to be made asymmetric around a         ", 	1,      5,     14,    490,    15,     5, 280
ih		 	FLbox  	"frequency other than the carrier, and is thereby useful for  ", 	1,      5,     14,    490,    15,     5, 300
ih		 	FLbox  	"formant positioning. By using a table lookup index of        ", 	1,      5,     14,    490,    15,     5, 320
ih		 	FLbox  	"I(r - 1/r), where I is the FM modulation index and r is an   ", 	1,      5,     14,    490,    15,     5, 340
ih		 	FLbox  	"exponential parameter affecting partial strengths, the       ", 	1,      5,     14,    490,    15,     5, 360
ih		 	FLbox  	"Palamin algorithm becomes relatively efficient, requiring    ", 	1,      5,     14,    490,    15,     5, 380
ih		 	FLbox  	"only oscil's, table lookups, and a single exp call.          ", 	1,      5,     14,    490,    15,     5, 400
