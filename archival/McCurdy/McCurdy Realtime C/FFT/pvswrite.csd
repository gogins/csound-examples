...
ih		 	FLbox  	"Manual Pointer", 	1,       5,    12,    100,     20,   255,   0
ih		 	FLbox  	"Speed Control ", 	1,       5,    12,    100,     20,   255,  20
...
ih		 	FLbox  	"using the 'play' button. 'pvsfread' is used to replay the    ", 	1,      5,     14,    490,    15,     5, 180
ih		 	FLbox  	"file and the user can choose between two modes of playback:  ", 	1,      5,     14,    490,    15,     5, 200
ih		 	FLbox  	"one in which a pointer through the file is controlled        ", 	1,      5,     14,    490,    15,     5, 220
ih		 	FLbox  	"manually and another in which the user controls the playback ", 	1,      5,     14,    490,    15,     5, 240
ih		 	FLbox  	"speed. The user can also modulate the transposition of the   " , 	1,      5,     14,    490,    15,     5, 260
ih		 	FLbox  	"file - this is implemented using the 'pvscale' opcode.       ", 	1,      5,     14,    490,    15,     5, 280
ih		 	FLbox  	"As the file is loaded once during playback, re-recording a   ", 	1,      5,     14,    490,    15,     5, 300
ih		 	FLbox  	"new file will not overwrite the original file loaded into    ", 	1,      5,     14,    490,    15,     5, 320
ih		 	FLbox  	"memory, instead performance will need to be restarted.       ", 	1,      5,     14,    490,    15,     5, 340
				FLpanel_end
