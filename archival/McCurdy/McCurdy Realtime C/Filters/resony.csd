...
gkscl, ihscl 			FLcount	"Scaling Mode", 		0,      2,    1,      1,      2,    150,     25,    175, 175,     -1
...
gksep2, gihsep2			FLcount	"Semitones", 			-48,   48, 0.01,      1,      1,    100,     20,    390, 406,     -1
gkbf2, gihbf2			FLcount	"Base Note", 			0,    127.0,    1,     12,      1,    100,     20,    390,  76,     -1

;SLIDERS					            			MIN | MAX | EXP | TYPE |  DISP | WIDTH | HEIGHT | X   | Y
gkbf,gihbf			FLslider 	"Base Frequency",		20,  20000, -1,    23,   idbf,    490,     25,    5,    50
gkbw,ihbw			FLslider 	"Bandwidth",			.01, 10000, -1,    23,   idbw,    490,     25,    5,   120
...
;SET INITIAL VALUES OF FLTK VALUATORS		VALUE | HANDLE
				FLsetVal_i	1000, 	gihbf
				FLsetVal_i	(octcps(1000)-3)*12, 	gihbf2
				FLsetVal_i	30, 	ihbw
				FLsetVal_i	1, 	ihscl
				FLsetVal_i	1, 	ihgain
				FLsetVal_i	10, 	ihnum
...
ih		 	FLbox  	"Scaling Modes:    0-None    1-Peak Response Factor of 1    2-Overall RMS Response Factor equals 1", 	1,        9,    12,    500,    10,     0, 220
...
instr	UpdateWidgets
	ktrig	changed	gksep
	FLsetVal	ktrig, gksep*12, gihsep2
	ktrig	changed	gksep2
	FLsetVal	ktrig, gksep2/12, gihsep1
	
	ktrig	changed	gkbf
	FLsetVal	ktrig, (octcps(gkbf)-3)*12, gihbf2
	ktrig	changed	gkbf2
	FLsetVal	ktrig, cpsmidinn(gkbf2), gihbf
