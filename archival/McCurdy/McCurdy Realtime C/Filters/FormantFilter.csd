...
#define	FORMANT_DATA(N)	
	#
	kfreq$N_U	tablei		kx*(2/5)*5,giBF1+(i(gkvoice)*15)+$N-1			;READ DATA FOR FREQUENCY (UPPER EDGE OF PANEL)
	kfreq$N_L	tablei		((3/5)+((1-kx)*(1/5)))*5,giBF1+(i(gkvoice)*15)+$N-1		;READ DATA FOR FREQUENCY (LOWER EDGE OF PANEL)
	kdbamp$N_U	tablei		kx*(2/5)*5,giBDb1+(i(gkvoice)*15)+$N-1			;READ DATA FOR INTENSITY (UPPER EDGE OF PANEL)                                      
	kdbamp$N_L	tablei		((4/5)+((1-kx)*(1/5)))*5,giBDb1+(i(gkvoice)*15)+$N-1	;READ DATA FOR INTENSITY (LOWER EDGE OF PANEL)                                      
	kbw$N_U		tablei		kx*(2/5)*5,giBBW1+(i(gkvoice)*15)+$N-1			;READ DATA FOR BANDWIDTH (UPPER EDGE OF PANEL)                                      
	kbw$N_L		tablei		((3/5)+((1-kx)*(1/5)))*5,giBBW1+(i(gkvoice)*15)+$N-1	;READ DATA FOR BANDWIDTH (LOWER EDGE OF PANEL)                                      
