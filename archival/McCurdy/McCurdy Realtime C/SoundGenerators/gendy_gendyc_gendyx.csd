...
gkOnOff,ihOnOff	FLbutton	"On/Off",	1,    0,    22,    120,     30,    5,  5,   -1
...
instr	1
	if gkOnOff==0 goto SKIP			;IF ON/OFF IS OFF GO TO SKIP LABEL
	...
	if gkopcode==0 then			;IF gendy IS CHOSEN...
	 ares	gendy	gkamp, gkampdist, gkdurdist, gkadpar, gkddpar, gkminfreq, gkmaxfreq, gkampscl, gkdurscl, i(gkinitcps), gknum
	elseif gkopcode==1 then			;IF gendyc IS CHOSEN...
	 ares	gendyc	gkamp, gkampdist, gkdurdist, gkadpar, gkddpar, gkminfreq, gkmaxfreq, gkampscl, gkdurscl, i(gkinitcps), gknum
	else					;OTHERWISE gendyx IS CHOSEN
	 ares	gendyx	gkamp, gkampdist, gkdurdist, gkadpar, gkddpar, gkminfreq, gkmaxfreq, gkampscl, gkdurscl,gkcurveup, gkcurvedown, i(gkinitcps), gknum
	endif
		out	ares			;SEND AUDIO TO OUTPUT
	SKIP:
endin
