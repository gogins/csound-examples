...
FLpanel_end
	...
	ih		 	FLbox  	"This example implements additive synthesis based on tables   ", 	1,      5,     14,    490,    20,     5,   40
	ih		 	FLbox  	"modal frequency ratios. Most of the data for these tables was", 	1,      5,     14,    490,    20,     5,   60
	ih		 	FLbox  	"gleaned from the appendix of the Csound Manual, the rest I   ", 	1,      5,     14,    490,    20,     5,   80
	ih		 	FLbox  	"derived myself.                                              ", 	1,      5,     14,    490,    20,     5,  100
	ih		 	FLbox  	"A common problem with additive synthesis implementations is  ", 	1,      5,     14,    490,    20,     5,  120
	ih		 	FLbox  	"that the user is confronted The user is provided with an     ", 	1,      5,     14,    490,    20,     5,  140
	ih		 	FLbox  	"overwhelming number of controls. In this example I have tried", 	1,      5,     14,    490,    20,     5,  160                                                         
	ih		 	FLbox  	"to limit the GUI to a minimum number of controls which still ", 	1,      5,     14,    490,    20,     5,  180
	ih		 	FLbox  	"provide power to produce a wide range of sounds.             ", 	1,      5,     14,    490,    20,     5,  200
