...
;			LABEL		WIDTH | HEIGHT | X | Y
	FLpanel		"pitchamdf", 	500,      290,   0,  0

;SWITCHES	  	             				ON | OFF | TYPE | WIDTH | HEIGHT | X | Y | OPCODE | INS | STARTTIM | DUR
gkOnOff, ihOnOff	FLbutton	"On/Off",		1,    0,    22,    140,     25,   10,  5,    0,      1,      0,       -1
gkmeters, ihmeters	FLbutton	"Meters On/Off",	1,    0,    22,    140,     25,   10,160,   -1
...
idrms				FLvalue	" ",	 80,      20,   10, 215
idcps				FLvalue	" ",	 80,      20,   10, 265
...
gkrms, gihrms			FLslider 	"rms",					0,         1,  0,    21,     idrms,   480,    25,    10,  190
gkcps, gihcps			FLslider 	"cps",					20,    10000, -1,    21,     idcps,   480,    25,    10,  240
...
ih		 	FLbox  	"'Pitchamdf' outputs two k-rate variables and for frequency   ", 	1,      5,     14,    490,    15,     5, 120
...
instr 		1
	...
	if gkmeters==1 then
		ktrigger	metro		10	;UPDATE RATE FOR METERS
