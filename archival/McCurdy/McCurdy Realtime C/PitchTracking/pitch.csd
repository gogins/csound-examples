...
;			LABEL		WIDTH | HEIGHT | X | Y
	FLpanel		"pitch", 	500,      500,   0,  0

;SWITCHES	  	             				ON | OFF | TYPE | WIDTH | HEIGHT | X | Y | OPCODE | INS | STARTTIM | DUR
gkOnOff, ihOnOff	FLbutton	"On/Off",		1,    0,    22,    140,     25,    5,  5,    0,      2,      0,       -1
...
idupdte				FLvalue	" ",	  80,    20,     5,  75
idlo				FLvalue	" ",	  80,    20,     5, 125
idhi				FLvalue	" ",	  80,    20,     5, 175
iddbthresh			FLvalue	" ",	  80,    20,     5, 225
idstrt				FLvalue	" ",	  80,    20,     5, 325
idq				FLvalue	" ",	  80,    20,     5, 375
idrolloff			FLvalue	" ",	  80,    20,     5, 475

;SLIDERS				            					MIN   | MAX | EXP | TYPE |  DISP   | WIDTH | HEIGHT | X  | Y
gkupdte, ihupdte		FLslider 	"Update Period (seconds)",		.001,    .1,   0,    23,  idupdte,    490,    25,     5,   50
gklo, ihlo			FLslider 	"Lower Pitch Detection Limit (oct)",	4,       14,   0,    23,  idlo,       490,    25,     5,  100
gkhi, ihhi			FLslider 	"Upper Pitch Detection Limit (oct)",	4,       14,   0,    23,  idhi,       490,    25,     5,  150
gkdbthresh, ihdbthresh		FLslider 	"Threshold of Detection (db)",		-90,     20,   0,    23,  iddbthresh, 490,    25,     5,  200
gkstrt, ihstrt			FLslider 	"Starting Pitch of Tracker (oct)",	4,       14,   0,    23,  idstrt,     490,    25,     5,  300
gkq, ihq			FLslider 	"Q of Filters",				0,       50,   0,    23,  idq,        490,    25,     5,  350
gkrolloff, ihrolloff		FLslider 	"Rolloff",				.001,   .99,   0,    23,  idrolloff,  490,    25,     5,  450

;COUNTERS							MIN | MAX | STEP1 | STEP2 | TYPE | WIDTH | HEIGHT | X | Y | OPCODE
gkfrqs, ihfrqs 			FLcount  "Octave Divisions",	1,    120,    1,     12,      1,    140,     25,    5, 250,   -1
gkconf, ihconf 			FLcount  "Conformations",	1,    100,    1,      5,      1,    140,     25,  175, 250,   -1
gkocts, ihocts 			FLcount  "Octave Decimations",	1,    100,    1,      5,      1,    140,     25,  350, 250,   -1
gknptls, ihnptls 		FLcount  "No. of Harmonics",	1,     50,    1,      5,      1,    140,     25,    5, 400,   -1

;SET INITIAL VALUES FOR SLIDERS 	VALUE | HANDLE
			FLsetVal_i	.01,	ihupdte
			FLsetVal_i	4,	ihlo
			FLsetVal_i	9,	ihhi
