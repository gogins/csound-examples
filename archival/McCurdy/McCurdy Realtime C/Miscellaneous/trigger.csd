...
FLpanel	"trigger",   500,    150,    0,  0
	...
	idthreshold	FLvalue	" ",	 70,      20,    0,  25
	idsignal	FLvalue	" ",	 70,      20,    0,  75

	;SLIDERS     					LABEL                 	MIN   | MAX | EXP | TYPE |  DISP      | WIDTH | HEIGHT | X  | Y
	gkthreshold, ihthreshold	FLslider	"Threshold",    	0,        1,    0,   1,   idthreshold,   500,    25,     0,   0
	gksignal, ihsignal		FLslider	"Trigger Signal",       0,        1,    0,   3,   idsignal,      500,    25,     0,  50
