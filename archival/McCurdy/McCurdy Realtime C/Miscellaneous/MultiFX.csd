...
gk$LLED, gih$LLED		FLbutton	"",	1,    0,     4,     10,     10,   ix+100, iy+15,   -1
FLsetColor2	255, 0, 0, gih$LLED	;SET INTERFACE COLOURS
gk$LOnOff, ih$LOnOff		FLbutton	"",	1,    0,    21,    200,    140,   ix+10,  iy+235,   0,     1,      0,       0.01,  $COUNT
...
;SWITCHES						ON | OFF | TYPE | WIDTH | HEIGHT |   X   |  Y   | OPCODE | INS | STARTTIM | DUR  | p4
gk$LLED, gih$LLED		FLbutton	"",	1,    0,     4,     10,     10,   ix+100, iy+15,   -1	;THE ON/OFF 'LED'
FLsetColor2	255, 0, 0, gih$LLED	;SET INTERFACE COLOURS
gk$LOnOff, ih$LOnOff		FLbutton	"",	1,    0,    21,    200,    140,   ix+10,  iy+235,   0,     1,      0,       0.01,  $COUNT	;THE 'FOOT' SWITCH
;KNOBS				LABEL   | MIN | MAX | EXP | TYPE | DISP | WIDTH | X | Y
...
#define	L	#VOLUME#				;THIS NAME SHOULD CORRESPOND TO THE NAME USED FOR THE GUI
	FLsetVal_i	1, gih$LLED			;THIS TURNS ON THE LED FOR THE EFFECT
	...
	if kStatus=0 then				;IF THIS EFFECT HAS BEEN TURNED OFF
		FLsetVal	1, 0, gih$LLED		;SWITCH OFF THE LED
