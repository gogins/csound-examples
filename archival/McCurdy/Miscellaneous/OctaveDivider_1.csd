...
;		LABEL            | WIDTH | HEIGHT | X | Y
	FLpanel	"Octave Divider",   500,    200,    0,  0
...
iddry				FLvalue	" ",       70,    20,     5, 125
idwet				FLvalue	" ",       70,    20,     5, 175

;SLIDERS						MIN   |  MAX | EXP | TYPE |  DISP     | WIDTH | HEIGHT | X | Y
gkToneFilt, ihToneFilt	FLslider "Tone Filter",		20,    20000,  -1,    23,  idToneFilt,   490,     25,    5,  50
gkdry, ihdry		FLslider "Dry",			0,        1,    0,    23,  iddry,        490,     25,    5, 100
gkwet, ihwet		FLslider "Wet",			0,        1,    0,    23,  idwet,        490,     25,    5, 150
...
ih		 	FLbox  	"The critical code of the octave divider is embedded within a ", 	1,      5,     14,    490,    20,     5, 300
ih		 	FLbox  	"UDO in order to facilitate easy transplantation into a       ", 	1,      5,     14,    490,    20,     5, 320
ih		 	FLbox  	"different project.                                           ", 	1,      5,     14,    490,    20,     5, 340
		FLpanel_end

		FLrun	;RUN THE FLTK WIDGET THREAD

opcode	OctaveDivider,a,akk
	ain,kdivider,kToneFilt	xin
	krms	rms		ain
	...
	ain	butlp		ain,1000	;LOWPASS FILTER THE INPUT SIGNAL (TO REMOVE SOME HF OVERTONE MATERIAL)
...
instr 1
	...
	aout	OctaveDivider	ain, gkdivider, gkToneFilt
