...
kDCINPUT 	port kDCINPUT * 10, 0.02


aInputVC interp kDCINPUT
...
<bsbPanel>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <width>281</width>
  <height>92</height>
  <uuid>{b6fb1f55-b9e3-4781-ad54-f961fd905873}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>Quindi è giusto questo codice?
Simula che sulla matrix sia connesso sia loscillatore sia il joy, sommando quindi i contributi.</label>
  <alignment>left</alignment>
  <font>Arial</font>
  <fontsize>12</fontsize>
  <precision>3</precision>
