...
kmod oscilikt gkFMdepth, gkFMrate, gkmodwave+1		;FM oscillator
...
aosc oscili ireson_OSC_amp*kamposc_exp, kfrq_tot, 1    ;!!!!!!!!!!  scaled oscili amplitude
...
aFILMIX_OSCIL_CLEAN =  (0.72 - kamposc_exp)* aFILMIX  + aosc   ;!!!!!!!!!!! add this line for pure OSC effect on VCF



aFILMIX_OSCIL distort1 aFILMIX_OSCIL_CLEAN, 2.5, 1, 0.2, 0.2
...
f2 0 4096 7 0 1024 1 2048 -1 1024 0
f3 0 4096 7 1 4096 -1
f4 0 4096 7 -1 4096 1
f5 0 4096 7 1 2048 1 0 -1 2048 -1
...
f97 0 1024 5 0.000001 512 0.000001 256 0.000001 128 0.0000015 64 0.001 64 1
...
On/Off</label>
 ...
 <bsbObject version="2" type="BSBDropdown">
  <objectName>modwave</objectName>
  <x>241</x>
  <y>595</y>
  <width>80</width>
  <height>24</height>
  <uuid>{bf2bfeea-471d-4ef6-9f65-5281a228aea2}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <bsbDropdownItemList>
 ...
 <bsbObject version="2" type="BSBGraph">
  ...
  <width>350</width>
  <height>150</height>
  <uuid>{602fc5f1-8475-4442-9f29-d9c3c212079e}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <value>0</value>
