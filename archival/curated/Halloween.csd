...
ifq2tab   =         p6
ipantab   =         p7
kamp      oscili     1, 1/idur, iamptab
kfq1      oscili     1, 1/idur, ifq1tab
kfq2      oscili     1, 1/idur, ifq2tab
kpan      oscili     1, 1/idur, ipantab
anoise    rand      kamp
...
kfq1      oscili     1,    1/idur, ifrmtab
kfa1      oscili     1,    1/idur, ifrmtab+1
kfq2      oscili     1,    1/idur, ifrmtab+2
kfa2      oscili     1,    1/idur, ifrmtab+3
kfq3      oscili     1,    1/idur, ifrmtab+4
kfa3      oscili     1,    1/idur, ifrmtab+5
kfq4      oscili     1,    1/idur, ifrmtab+6
kfa4      oscili     1,    1/idur, ifrmtab+7
kfq5      oscili     1,    1/idur, ifrmtab+8
kfa5      oscili     1,    1/idur, ifrmtab+9
kfqc3     =         kfqc*.7
...
kfqc      randh     ifqc, 200
aop4      oscili     10*kamp4,   3*(1+.8*aop4)*kfqc, 1
aop3      oscili     20*kamp3,     .5*(1+aop4)*kfqc, 1
aop2      oscili     16*kamp2,            5.19*kfqc, 1
aop1      oscili     2*kamp1, .5*(1+aop2+aop3)*kfqc, 1 
...
aop8      oscili     kamp4,   iop5f, 1
ap1       =         aop8+1
aop1      oscili     kamp1,   ap1*iop1f, 1
aop2      oscili     kamp2,   ap1*iop2f, 1
aop3      oscili     kamp2,   iop3f, 1
aop4      oscili     kamp2,   iop4f, 1
aop5      oscili     kamp3,   iop5f*5, 1
;aop6      oscili     kamp2,   iop5f+aop5*ifqc, 1
aop7      oscili     kamp2,   iop7f, 1
...
kfqci     oscili     ifqc, 1/idur, ifqtab
kpan      oscili     1, 1/idur, ipantab
kamp      oscili     1, 1/idur, iamptab
...
klfo      oscili     1, .5, 1, .5
kfqc      =         ifqc + klfo
;aop3    oscili      9*kamp3,              3.14*kfqc, 1
aop3      oscili     2*kamp3,             3.14*kfqc, 1
aop2      oscili     .2*kamp2,             .78*kfqc, 1
aop1      oscili     kamp1,            (1+aop2+aop3)*kfqc, 1
aout      =         aop1 
          outs      aout*kamp*ipanl, aout*kamp*ipanr
...
ipantab   =         p7
ksh       randh     5000, krt
a2        oscili     2, 100, 1                ;SINE OSC (F1) CONTROLLED BY S&H
ksh       =         ksh * ifreq              ;* .5
a4        reson     a2,ksh,50                ;FILTER WITH S&H CONTROLING THE FCO
a3        oscili     a4,1/p3,13               ;a3 IS THE OUTPUT f13 ADSR
a3        =         a3 * igain
kpan      oscili     1,.14, ipantab
aoutl     =         a3 * (1-kpan)
aoutr     =         a3 * kpan
          outs      aoutl,aoutr
          endin
