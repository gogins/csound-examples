<CsoundSynthesizer>
<CsOptions>
csound -g --expression-opt -W -o Sublimation.wav temp.orc temp.sco
</CsOptions>
<CsInstruments>
...
;asig1   poscil  ae, ipch1, ifn
asig2	poscil	ae, ipch2, ifn
adiff	poscil  ae, idiff, ifn
adiff2	poscil	ae, idiff2, ifn
adiff3	poscil	ae, idiff3, ifn
aper	poscil	ae, iper, ifn
asum	poscil	ae, isum, ifn
asum2	poscil	ae, isum2, ifn
...
; WTP Opening Chord
; combos, successively
i 2 0   [(60*4)-30] 2000 1 $PCH.(30'4'1)  3  2  .9     1
...
i 2 30  [60*3]      2000 1 30             4  1  .96    1
i 2 .   .           .    . .              6  .  .8     1
i 2 .   .           .    . .              7  .  .64    1
i 2 .   .           .    . .              8  .  .48    1
i 2 .   .           .    . .              9  .  .32    1
...
; WTP Magic Chord
; combos against the base
i 2 60  [(60*3)-30] 2000 1 1.875         81  1  1	   0
i 2 .   .           .    . .             84  .  .875   0
i 2 .   .           .    . .            108  .  .75    0
i 2 .   .           .    . .            112  .  .625   0
i 2 .   .           .    . .            144  .  .5     0
...
; combos against the base
i 2 120 [60*3]      2000 1 .46875       512  1  .990   0
i 2 .   .           .    . .            567  .  .9186  0
i 2 .   .           .    . .            588  .  .8472  0
i 2 .   .           .    . .            756  .  .7758  0
i 2 .   .           .    . .            784  .  .7044  0
...
; WTP Magic Chord
; combos, successively
i 2 210 [(60*2)+15] 2000 1 $PCH.(1.875'81'1)  28 27  .8571 0
